...
const Designer = () => {
  ...
  useDndMonitor({
    onDragEnd: (event: DragEndEvent) => {
      ...
      // First escenario: dropping a sidebar btn element over the designer drop area
      ...
      // Second escenario: dropping a designer element over another designer element
      ...
      const isDroppingOverDesignerElement = isDropingOverDesignerElementTopHalf || isDropingOverDesignerElementBottomHalf;
      ...
      if (droppingSidebarBtnOverDesignerElement) {
        ...
        let indexForNewElement = overElementIndex; // I assume i'm dropping over the top half of the element
        if (isDropingOverDesignerElementBottomHalf) {
      ...
      // Third scenario: dragging a designer element over the designer drop area
...
function DesignerElementWrapper({element} : {element:FormElementInstance}) {
  ...
  return (
    <div
      ...
      <div className={cn('flex w-full h-[120px] items-center rounded-md bg-accent/40 px-4 py-2 pointer-events-none opacity-100 transition-opacity duration-300',
